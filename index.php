            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="?p=home" class="logo"><span>Aplikasi</span></a>
                    </div>
                </div>
                    ...
                    <div class="container">
                        <div class="">
                            ...
                            <ul class="nav navbar-nav navbar-right pull-right">
                                ...
                                <li class="dropdown">
                                    <a href="" class="dropdown-toggle profile" data-toggle="dropdown" aria-expanded="true">Selamat Datang, <?php echo $hasil['username']; ?> <img src="./assets/images/user.png" alt="user-img" class="img-circle"> </a>
                                    <ul class="dropdown-menu">
										<li><a href="?p=change_passwd"><i class="md md-lock"></i> Ganti Password</a></li>
            ...
            <div class="left side-menu">
                <div class="sidebar-inner slimscrollleft">
                    <div class="user-details">
                        <div class="pull-left">
                            <img src="assets/images/user.png" alt="" class="thumb-md img-circle">
                        </div>
                        <div class="user-info">
                            <div class="dropdown">
                    ...
                    <div id="sidebar-menu">
                        <ul>
							...
							<li>
                                <a href="?p=perpus" class="waves-effect"><i class="fa fa-book"></i><span> Buku </span></a>
                            </li>
							<li>
                                <a href="?p=list" class="waves-effect"><i class="glyphicon glyphicon-list-alt"></i><span> List Log </span></a>
                            </li>
							...
							<?php if ($hasil['level']=='Administrator') { ?>
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="?p=tambahk">Tambah User</a></li>
									 <li><a href="?p=olahk">Olah User</a></li>
                                </ul>
                            </li>
<?php } ?>
<?php } ?>
